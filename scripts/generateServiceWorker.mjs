...
const registerTemplate = readFileSync(resolve(import.meta.dirname, 'registerServiceWorker-template.js'), encoding);
const swTemplate = readFileSync(resolve(import.meta.dirname, 'serviceWorker-template.js'), encoding);
...
writeFileSync(resolve(publicPath, 'registerServiceWorker.js'), registerResult, encoding);
