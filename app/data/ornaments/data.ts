...
export const ORNAMENT_LIST = [
	...
	},
	{
		id: 34,
		name: '强运桃子',
		description: '并不是真正的桃子，似乎是比那名居天子亲手做的。虽然不能吃，但据说能带来好运。',
		dlc: 0,
	...
	},
	{
		id: 51,
		name: '幸运的素兔？',
		description: '怎么看都像是随手抓来的兔子，但因为是帝抓来的，竟然有着奇妙的幸运。',
		dlc: 0,
	...
	},
	{
		id: 3000,
		name: '飞碟老虎机',
		description: '使用真相不明的能力制造的迷之机器，据说灵感来源于外面世界的某种机器。',
		dlc: 3,
	...
	},
	{
		id: 4001,
		name: '超级钓鱼竿',
		description: '可以进行精细高级操作的钓鱼竿，除了能够钓鱼，还能够寻找到宝箱！非常神奇！',
		dlc: 4,
		effect: '在地下室的展示柜中启用后，各地会出现钓鱼点。',
		from: {
			bond: 4005,
	...
	},
	{
		id: 5014,
		name: '造物者之盒',
		description: '来自另一个次元的“终极礼物”，能让拥有者成为“造物主”的神奇盒子。',
		dlc: 5,
