...
export const CUSTOMER_RARE_LIST = [
	{
		...
		spellCards: {
			positive: [
				{
					name: '灯符【荧光现象】',
					description: '客人刷新时间减少30%，持续60秒。',
				},
			],
			negative: [
				{
					name: '蠢符【夜虫龙卷】',
					description: '一口气将店内的客人统统驱赶。',
				},
			],
		},
		positiveTagMapping: {},
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '月符【月光射线】',
					description: '随机获得图鉴中记录的三种肉类食材（若图鉴记录的肉类食材只有两种，则获得两种）。',
				},
			],
			negative: [
				{
					name: '暗符【境界线】',
					description: '在厨房放出黑雾，让你无法辨识哪些是厨具，哪些是食柜，持续20秒消失。',
				},
			],
		},
		positiveTagMapping: {
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '仙符【凤凰卵】',
					description: '随机自动获得三种鱼类食材，偶然会出现高级货。',
				},
			],
			negative: [
				{
					name: '方符【奇门遁甲】',
					description: '减少客人的出现率。',
				},
			],
		},
		positiveTagMapping: {
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '三种神器【剑】',
					description: '随机获得两种蔬菜。',
				},
				{
					name: '三种神器【镜】',
					description: '接下来的15秒内，料理不会消耗任何材料。',
				},
				{
					name: '三种神器【玉】',
					description: '随机解锁一名未完全解锁全部喜好的稀客的一个信息。',
				},
				{
					name: '三种神器【乡】',
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '撰书【这也全部是妖精干的吗】',
					description: '获得一张名小说家的签名色纸，可以用来换些特别的东西！',
				},
			],
			negative: [
				{
					name: '口授【黑心店家的黑心历史】',
					description: '店内气氛掉落到冰点，客人也会降低心情。',
				},
			],
		},
		positiveTagMapping: {
	...
	},
	{
		...
		bondRewards: [
			{
				type: '摆件',
				reward: '富贵牡丹',
				description: '客人对料理的评价若至少为普通，则心情额外增加15',
			},
			{
				type: '伙伴',
				reward: '本居小铃',
		...
		spellCards: {
			positive: [
				{
					name: '【猛兽的艺术用法】',
					description: '每隔一段时间，在场排队和就座的客人，每人随机打赏1-30元。',
				},
			],
			negative: [
				{
					name: '【断恶修善的禁欲考验】',
					description: '客人们在三十秒内只会点最便宜的食物和绿茶。',
				},
			],
		},
		positiveTagMapping: {},
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '梦符【二重结界】',
					description: '发动一次保护结界，可以完全防御下一个稀客的惩罚符卡。',
				},
			],
			negative: [
				{
					name: '"灵符【梦想封印】',
					description: '封印你菜单上的三个料理，在接下来的30秒内，无法制作。',
				},
			],
		},
		positiveTagMapping: {
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '酒吞奥义【鬼进酒】',
					description: '赠送一种酒水给你，偶然会出现超高级货。',
				},
			],
			negative: [
				{
			...
			negative: [
				{
					name: '【天罚的石柱】',
					description:
						'从天而降的要石破坏桌椅，吓走桌面上的客人，该桌椅在60秒内需要修理，期间无法再使用，所以也无法再接待新的客人。',
				},
			],
		},
		positiveTagMapping: {
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '华符【芳华绚烂】',
					description: '接下来的30秒内，每2秒提升1点店内气氛，且期间稀有客人完成订单后获得的好感度提高。',
				},
			],
			negative: [
				{
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '【甜美的冰霜小妖精】',
					description: '随机获得三种带有“可加冰”标签的平价酒水，并且获得2-5枚冰块。',
				},
			],
			negative: [
				{
					name: '冻符【完美冻结】',
					description:
						'随机冻住3只厨具，如果厨具中有正在制作或完成但还未拿走的料理，则会直接被冻碎，持续30秒。',
				},
			],
		},
		positiveTagMapping: {
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '知识的奇妙冒险【文化之风】',
					description: '接下来的30秒内，给客人上含有“文化底蕴”标签的料理，必然获得最高等级的评价。',
				},
			],
			negative: [
				{
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '不死【火鸟 凤翼天翔】',
					description: '20秒内所有厨具的料理速度加快50%。',
				},
			],
			negative: [
				{
					name: '藤原【灭罪寺院伤】',
					description: '接下来的30秒，无论提供多好的料理，最高只能获得客人普通的评价。',
				},
			],
		},
		positiveTagMapping: {
			...
			positive: [
				{
					name: '生机【四十叶草般的幸运】',
					description:
						'所有食材采集点的冷却时间清零，原地复活，并且次日进行采集活动时，可以额外获得1-2份食材。',
				},
			],
			negative: [
				{
					name: '想起【那年的素兔的恐怖】',
					description:
						'再一次激活强买强卖功能，让你呜呼哀哉。如果胆敢不买，将发动另一张符卡“恶作剧【Combo消失术】”中断你的Combo，并且在30秒内无法再获得Combo。',
				},
			],
		},
		positiveTagMapping: {
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '河童【延展手臂】',
					description: '接下来的120秒内，伙伴都可以通过“延展手臂”远程上菜上酒。',
				},
			],
			negative: [
				{
					name: '水符【山洪暴发】',
					description: '引发水患，招来洪水，巨大的波浪将会冲走随机3~5名顾客。',
				},
			],
		},
		positiveTagMapping: {
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '【天狗例行小酌】',
					description: '接下来的120秒内，将会有大量白狼天狗客人上门。',
				},
			],
			negative: [
				{
					name: '【戒严令】',
					description: '禁止任何客人前来，持续30秒。',
				},
			],
		},
		positiveTagMapping: {
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '【和人偶一起玩的孩子】',
					description: '爱丽丝的人偶幻化为客人，填充剩余的全部座位。',
				},
			],
			negative: [
				{
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '流星【超级英仙座】',
					description: '随机自动获得三种菌类食材，偶然会出现高级货。',
				},
			],
			negative: [
				{
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '魔符【即席菩提】',
					description: '接下来的60秒内，客人在结账时，额外会支付50%的小费作为化缘。',
				},
			],
			negative: [
				{
					name: '地藏【业火救济】',
					description: '业火烧掉随机的三个Buff纸张，其带来的效果也会随之失效。',
				},
			],
		},
		positiveTagMapping: {
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '【地下偶像狂欢夜】',
					description: '接下来30秒内，排队客人会被偶像吸引，即使夜间营业结束也不会离去。',
				},
			],
			negative: [
				{
					name: '细索【犍陀多绳索】',
					description: '移动速度将会下降80%，持续30秒。',
				},
			],
		},
		positiveTagMapping: {
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '【嫉妒与透支】',
					description: '将所有在座的客人的预算拉到与在座最富客人同等的水准。',
				},
			],
			negative: [
				{
					name: '恨符【丑时参拜】',
					description: '符卡一旦发动，当夜结算时收取翻倍佣金。',
				},
			],
		},
		positiveTagMapping: {
			...
			positive: [
				{
					name: '【接着奏乐接着舞】',
					description:
						'使用星熊杯将一定数量的酒水升级成更高一级的酒水。100%升级3杯1级酒水，75%升级2杯2级酒水，50%升级1杯3级酒水。',
				},
			],
			negative: [
				{
					name: '四天王奥义【三步必杀】',
					description:
						'勇仪生成三重警戒圈，限制你的移动，持续60秒；移动速度下降50%，直到离开范围；进入该范围将被立即击晕30秒。',
				},
			],
		},
		positiveTagMapping: {
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '猫符【猫醉步】',
					description: '接下来30秒内，给客人上含有“中酒精”标签的酒水，必然获得最高等级的评价。',
				},
			],
			negative: [
				{
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '【地狱的托卡马克装置】',
					description: '接下来60秒内，煮锅与蒸锅核功率过载，能瞬间完成料理。',
				},
			],
			negative: [
				{
					name: '狱光【扩散地狱火】',
					description:
						'下一次没有成功完美演唱的料理，会使厨具将发生核燃炸毁，当晚无法使用，排队一部分客人也会被吓得抱头鼠窜。',
				},
			],
		},
		positiveTagMapping: {},
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '想起【高兴的事情】',
					description: '随机发动一名已解锁稀客（不包括自己）的奖励符卡。',
				},
			],
			negative: [
				{
					name: '想起【不高兴的事情】',
					description: '随机发动一名已解锁稀客（不包括自己）的惩罚符卡。',
				},
			],
		},
		positiveTagMapping: {
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '雨符【雨夜怪谈】',
					description: '接下来30秒内，带有“猎奇”标签的食物制作速度提高30%且额外提供30%续单率。',
				},
			],
			negative: [
				{
					name: '【超级巨幻影唐伞】',
					description: '所有排队中的普通客人被吓跑。',
				},
			],
		},
		positiveTagMapping: {
	...
	},
	{
		...
		spellCards: {
			...
			negative: [
				{
					name: '溺符【深海漩涡】',
					description: '5秒无法行动（可通过上下左右摇杆减少时间），之后的20秒间，上下左右移动方向相反。',
				},
			],
		},
		positiveTagMapping: {
			...
			positive: [
				{
					name: '开心【东方红绿蓝】',
					description:
						'开动飞碟转盘，必然中奖，结果为以下四种情况的一个：红红红：接下来的15秒，无论上什么菜都必然获得最高等级的评价；绿绿绿：接下来的15秒，食材和酒水不会被消耗；蓝蓝蓝：接下来的15秒，收入提高100%；红绿蓝：同时获得以上三种Buff。',
				},
			],
			negative: [
				{
					name: '恶心【东方红红蓝】',
					description:
						'开动飞碟转盘，必然Miss，结果为以下四种情况的一个：红红绿：接下来的15秒，无论上什么菜都必然获得极度不满的评价；绿绿〇：接下来的15秒，食材与酒水消耗量提高到三倍；蓝蓝〇：接下来的15秒，收入减少66%；红红蓝：同时获得以上三种buff。',
				},
			],
		},
		positiveTagMapping: {
			...
			positive: [
				{
					name: '圣童女【太阳神的贡品】',
					description:
						'符卡触发后的10秒内，根据客人评价获得酒水奖励，“普通”评价获得1级酒水，“满意”评价获得2级酒水，“完美”评价获得3级酒水。',
				},
			],
			negative: [
				{
					name: '传薪【浴火捏盘】',
					description: '本符卡发动的30秒内，只能使用1个托盘进行服务。被禁用托盘内的还未拿走的物品会被焚毁。',
				},
			],
		},
		positiveTagMapping: {
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '邪术【天下无墙】',
					description: '30秒内伙伴在食堂区域移动时可以穿过客人或障碍物。',
				},
			],
			negative: [
				{
					name: '入魔【走火入魔】',
					description:
						'接下来30秒，稀客进入走火入魔状态，每次结账，无论评价高低，都有30%概率放一次惩罚符卡。如果本来就放惩罚符卡的情况，则多放一次。',
				},
			],
		},
		positiveTagMapping: {
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '雷影【电光石火】',
					description: '30秒内自己和伙伴的移动速度提升30%。',
				},
			],
			negative: [
				{
					name: '天罚【天雷暴击】',
					description: '下一次没有成功完美演唱的料理，将会引来天雷，击晕一个伙伴30秒。',
				},
			],
		},
		positiveTagMapping: {
			...
			positive: [
				{
					name: '宝槌【通货膨胀危机】',
					description:
						'使用万宝槌敲击收银台，叠加1层“万宝槌之力”。万宝槌充盈的魔力将在营业结束时使营业额膨胀，第1层“万宝槌之力”使收入提高7%，之后每层使收入提高2%。',
				},
			],
			negative: [
				{
			...
			positive: [
				{
					name: '欺符【超限效应】',
					description:
						'令全场自身以外客人的厌恶标签反转为喜好标签，持续30秒。当场上包括排队客人在内的普通客人数量之和不少于7时，此符卡转化为“逆弓【天壤梦弓的诏敕】”，使场上包括排队客人在内的普通客人额外获得1次续单上限与25%预算，每位普通客人最多可以受到此效果影响3次。',
				},
			],
			negative: [
				{
					name: '逆转【颠倒世界】',
					description:
						'将自身的预算与全场最高预算水平的客人预算翻转，并在接下来的15秒内持续将自己以外的全场所有客人的预算降低到全场最低预算客人水平。',
				},
			],
		},
		positiveTagMapping: {
			...
			positive: [
				{
					name: '狼魂【野性觉醒】',
					description:
						'使客人在接下来30秒内爱上“肉”与“山珍”标签，在对料理评分时作为自身的喜好进行评价，原本喜好这些标签的客人食用相关料理时必然触发最高评价。',
				},
			],
			negative: [
				{
					name: '饿狼【暴食的月下舞踏】',
					description:
						'接下来的30秒内，所有客人的料理如果没有添加“饱腹”标签，会触发最差评价，同时原本厌恶“饱腹”标签的客人，则必然触发最差评价。',
				},
			],
		},
		positiveTagMapping: {
			...
			positive: [
				{
					name: '【八衢潮流风靡幻想】',
					description:
						'明天开始店铺变为“明星店”，3天后恢复正常。“明星店”：提高10%客人预算与5%客流量，“招牌”标签成为流行标签。若店铺已是“明星店”或当晚已宣传，则此符卡转化为“【食堂风起厨神无双】”。“【食堂风起厨神无双】”：成品带有“招牌”标签的今日菜单上的料理将成为明星料理。制作明星料理时若料理时间小于5秒则瞬间完成；在舆论的裹挟下，追捧“流行喜爱”标签的客人食用明星料理后额外提高30%续单率，返还当单酒水消耗的预算，并100%增加1次续单上限（增加续单上限效果每桌客人只触发一次），持续30秒。',
				},
			],
			negative: [
				{
					name: '【笔枪纸弹禁制之道】',
					description:
						'接下来30秒内无法进行投掷上菜。同时在报纸上对黑心店铺进行抨击，使“明星店”加成明天起消失。',
				},
			],
		},
		positiveTagMapping: {
			...
			positive: [
				{
					name: '【花鸟风月群芳沐】',
					description:
						'在场上种下一朵鲜花并利用能力使其生长，满心情时额外种下一朵，每朵生长的鲜花每24秒生产25小费。幽香以外的稀客释放奖励符卡时，随机一朵生长的鲜花将吸收符卡之力而盛放，吸引当地出没的稀有客人造访食堂，被鲜花吸引来的稀有客人会摘走这朵鲜花。鲜花盛放期间客人用餐结束后额外提高15心情，15秒后鲜花凋谢，获得1层“【落英缀裳】”。“【落英缀裳】”：可以抵挡一次中断Combo的失误。',
				},
			],
			negative: [
				{
					name: '【决斗Spark!!!】',
					description:
						'用微笑的表情走到自己所在座位那一排的最上方，然后一发魔炮将这排所有的桌子轰飞，当夜不可修复，并吓跑所有在这些位置用餐的客人。',
				},
			],
		},
		positiveTagMapping: {
			...
			positive: [
				{
					name: '分解【剧毒中和】',
					description:
						'移除“铃兰【凋零花园】”状态；梅蒂欣操纵料理中可能存在的有害元素，使料理时的标签不再产生冲突，持续30秒，并立即获得带有“中酒精”标签的酒水1瓶。。',
				},
			],
			negative: [
				{
					name: '铃兰【凋零花园】',
					description:
						'移除“分解【剧毒中和】”状态；制作料理时铃铃会额外为料理追加特殊的“忧郁之毒”标签，食用带有该标签的食物的客人不会续单，持续30秒。',
				},
			],
		},
		positiveTagMapping: {
			...
			positive: [
				{
					name: '【幽冥的轮回】',
					description:
						'如果场上不存在“幽玄封魔阵”则生成法阵，如果存在则为法阵填充2点能量。“幽玄封魔阵”：魅魔以外的稀客释放任意符卡时填充1点能量。能量达到7点时，消耗全部能量引发“梦符【时空一粟】”。“梦符【时空一粟】”：场上所有入座客人的剩余预算回复到上限，接下来20秒内，制作料理不消耗食材且瞬间完成，客人必定给出最高评价。',
				},
			],
			negative: [
				{
					name: '【渎神的代价】',
					description: '受到“恶灵缠怨”：接下来30秒内无法获得夜雀之歌类Buff，且无法触发特殊厨具效果。',
				},
			],
		},
		positiveTagMapping: {
			...
			positive: [
				{
					name: '【传奇的格列佛】',
					description:
						'露易兹召唤一架魔法相机停留在店内，若稀有客人本尊离开时未吃饱且预算未耗尽，则相机拍下该稀客并转换为一份“旅者博客”。当日结束后“旅者博客”解放（若拍摄时当日已结束则立即解放），投影出其拍摄的客人形象再次光临食堂，以此方式形成的稀客影像可以使用符卡，喜好与原先无异，但预算为其离开时的预算，续单上限为其离开时剩余的可点单数。',
				},
			],
			negative: [
				{
					name: '【遗落的水晶鞋】',
					description: '当晚营业结束后，再经过60秒，将会强制驱逐店铺内的客人并关店。',
				},
			],
		},
		positiveTagMapping: {
			...
			positive: [
				{
					name: '【恋爱的糖果屋】',
					description:
						'接下来30秒内，当完成场上客人的订单且至少获得普通评价后，在座位附近掉落一枚“蓬松松糖果”以供拾取。',
				},
			],
			negative: [
				{
					name: '【呜撒的猫咪】',
					description: '使伙伴移动速度下降30%，工作速度下降50%，持续30秒。',
				},
			],
		},
		positiveTagMapping: {
			...
			positive: [
				{
					name: '【月免的篝火盛宴】',
					description:
						'召开一场盛大的篝火盛宴，场上每只存在的兔子生成1个随机食材或1瓶随机酒水，接下来30秒内出现新的兔子时会同样生成食材或酒水。生成食材的概率为80%，生成酒水的概率为20%。',
				},
			],
			negative: [
				{
					name: '【酒醉迷乱】',
					description:
						'铃仙向场上打出一颗狂气之弹，持续影响场上的客人，狂气持续30秒。受到狂气影响的客人食用高酒精以外的饮料必定给出最低评价。',
				},
			],
		},
		positiveTagMapping: {
			...
			positive: [
				{
					name: '方圆【山海千重】',
					description:
						'丰姬连接海与山，链接幻想乡的一个地点，使该区域的普通客人与稀有客人可以穿越“面”前来。通过丰姬的能力链接的地区刷新效果分别独立，刷新速率为原先的33%。',
				},
			],
			negative: [
				{
					name: '晦朔【天地未形】',
					description:
						'丰姬从当地出没稀客以及当晚邀请稀客中随机选择3个还未出现的角色，使她们“神隐”，今晚无法前来夜雀食堂。',
				},
			],
		},
		positiveTagMapping: {
			...
			positive: [
				{
					name: '神诏【众神谕使】',
					description:
						'依姬召唤神灵，附加一层“神耀桂冠”，如果本次提供的料理带有“传说”标签，则额外附加一层。当稀有客人产生不为完美的评价时，消耗一层“神耀桂冠”引发神迹，将评价提升至完美。',
				},
			],
			negative: [
				{
					name: '诫罚【诸神圣裁】',
					description:
						'依姬引发神迹将部分传说封印，接下来30秒内，带有“传说”标签的料理或使用带有“传说”标签的食材制作的料理无法被制作。',
				},
			],
		},
		positiveTagMapping: {
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '【香霖堂购物节】',
					description: '获得一张香霖堂购物7折的打折卡，仅限次日使用，过期作废。',
				},
			],
			negative: [
				{
					name: '【虚构的情报】',
					description: '已经解锁的稀客喜好信息，会随机被隐藏。',
				},
			],
		},
		positiveTagMapping: {
			...
			positive: [
				{
					name: '红符【红色不夜城】',
					description:
						'本日结束时使食堂进入“红色不夜城”状态（若已结束则立即触发），持续至营业结束。“红色不夜城”：普通客人的预算不会低于500；伙伴的工作速度提高100%，如果是咲夜则将工作速度提高至极限；客人的续单率提高100%；发动时如果蕾米莉亚本人此时依然在场，则接下来60秒内不会闭店，并以300%的速率继续刷新普通客人。否则在场上的最后一位稀客离开时，依照当晚触发的奖励符卡数量召唤对应数量的妖精女仆前来。',
				},
			],
			negative: [
				{
	...
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '狱界剑【二百由旬之一闪】',
					description: '在60秒内制作料理台的料理时能瞬间完成。',
				},
			],
			negative: [
				{
					name: '天上剑【天人之五衰】',
					description: '客人耐心衰减速度翻倍，且每2秒减少1点气氛，持续60秒。',
				},
			],
		},
		positiveTagMapping: {},
			...
			positive: [
				{
					name: '【食物瞬间消失术】',
					description:
						'接下来直到营业结束为止，客人会瞬间吃下所有的料理。再次触发时此符卡转化为“【墨染浮櫻化醉蝶】”。“【墨染浮櫻化醉蝶】”：幽幽子释放1/3/5/8（随使用次数提升）只蝴蝶飞向保温箱，每只蝴蝶吞噬保温箱中存储的一个料理，转化为等同于4倍料理价格的金钱（享受小费倍率加成）。',
				},
			],
			negative: [
				{
					name: '【加料加量不加价】',
					description: '接下来直到营业结束为止，所有的料理不加满5个档位的料，都会收到差评。',
				},
			],
		},
		positiveTagMapping: {},
			...
			positive: [
				{
					name: '【扶我起来，我还能吃】',
					description:
						'包括排队人物在内的在场所有客人30%增加1次额外续单，每位客人概率独立计算。通过此种方式增加的额外续单将无视预算上限。',
				},
			],
			negative: [
				{
					name: '【饭要一口一口吃才健康】',
					description:
						'包括排队人物在内的所有客人，用餐时间增加到200%，但此技能效果优先级低于立刻完食类Buff。',
				},
			],
		},
		positiveTagMapping: {},
			...
			positive: [
				{
					name: '【不玩尽兴还想走?!】',
					description:
						'使用空间能力将在场所有就餐客人封闭起来，只要顾客还吃得下并且有能消费得起的料理，就必须消费，直到花费额度至少到达预算的70%上限才会解除，在解除前，客人无法离开桌子，只能继续点单。持续60秒。',
				},
			],
			negative: [
				{
					name: '拷问【頞部陀】',
					description: '接下来的120秒内，制作所有含有“清淡”或“素”标签的料理，最终只能做出黑暗料理。',
				},
			],
		},
		positiveTagMapping: {},
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '因果【推理与判断之眼】',
					description: '通过能力，在120秒内辨识客人的剩余预算与点单次数。',
				},
			],
			negative: [
				{
					name: '律符【颠倒错乱】',
					description: '接下来的60秒间，无论上的食谱如何合衬客人的心意，得到的评价都是随机的一种。',
				},
			],
		},
		positiveTagMapping: {},
	},
	{
		...
		spellCards: {
			positive: [
				{
					name: '【饕餮的饕餮之宴】',
					description: '所有尤魔以外的客人都只会点最贵的食物与酒水，且这些订单不消耗预算，持续30秒。',
				},
			],
			negative: [
				{
					name: '【刚欲兽神饕餮的晚餐】',
					description:
						'暴走的尤魔将会吞噬掉随机3~5个食材，1~3个酒水，并吞噬1个厨具，使该厨具当晚无法使用。血池地狱挑战中，会额外恢复5%的HP。',
				},
			],
		},
		positiveTagMapping: {
			...
			positive: [
				{
					name: '【自在极意无意识】',
					description:
						'接下来的60秒内，顾客点单、吃饭、店员操作等所有需要冷却时间的动作，全部无冷却、无意识发动，达到理论速度的极限。',
				},
			],
			negative: [
				{
					name: '【自我极意无意识】',
					description: '接下来的60秒内，普客点单全部变成被恋恋遮住的盲单，需要通过查询图鉴喜好来完成。',
				},
			],
		},
		positiveTagMapping: {
			...
			positive: [
				{
					name: '【魔卡小狸十股变化】',
					description:
						'召唤若干狸猫，变化成所有就座客人的样子（不包括揣藏本人），并且重新加入到排队队列中。狸猫变化的客人，喜好与预算和变化对象无异，但所有狸猫变化成的稀有客人整晚只能释放一次变化对象的符卡。',
				},
			],
			negative: [
				{
			...
			negative: [
				{
					name: '【现与隐的境界】',
					description:
						'在场上开启数个会变换位置的隙间，若接近隙间则会被吸入其中，然后随机传送到其他隙间处，同时托盘内的酒水会消失。隙间持续30秒。',
				},
			],
		},
		positiveTagMapping: {
