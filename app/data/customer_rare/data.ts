			...
			positive: [
				{
					name: '「接着奏乐接着舞」',
					description:
						'将一定数量的酒水升级成更高一级的酒水。100%升级三杯1级酒水，75%升级两杯2级酒水，50%升级一杯3级酒水。',
				},
			],
			negative: [
				{
			...
			negative: [
				{
					name: '入魔「走火入魔」',
					description:
						'稀有顾客每次结账，无论评价高低，都有30%概率放一次惩罚符卡。如果是本来就会放惩罚符卡的情况，则多放一次。持续30秒。',
				},
			],
		},
		positiveTagMapping: {
			...
			positive: [
				{
					name: '「传奇的格列佛」',
					description:
						'露易兹召唤一架魔法相机停留在店内，若稀有顾客本尊离开时未吃饱且预算未耗尽，则相机拍下该稀有顾客并转换为一份“旅者博客”。当日结束后“旅者博客”解放（若拍摄时当日已结束则立即解放），投影出其拍摄的顾客形象再次光临食堂，以此方式形成的稀稀有顾客的影像可以使用符卡，喜好和原先无异，但预算为其离开时的预算，续单上限为其离开时剩余的可点单数。',
				},
			],
			negative: [
				{
			...
			positive: [
				{
					name: '红符「红色不夜城」',
					description:
						'本日结束时使食堂进入“红色不夜城”状态（若已结束则立即触发），持续至营业结束。“红色不夜城”：普通顾客的预算不会低于500；伙伴的工作速度提高100%，如果是咲夜则将工作速度提高至极限；顾客的续单率提高100%；发动时如果蕾米莉亚本人此时依然在场，则接下来60秒内不会闭店，并以300%的速率继续刷新普通顾客。否则在场上的最后一位稀有顾客离开时，依照当晚触发的奖励符卡数量召唤对应数量的妖精女仆前来。',
				},
			],
			negative: [
				{
			...
			positive: [
				{
					name: '「扶我起来，我还能吃」',
					description:
						'包括排队顾客在内的所有顾客30%增加一次额外续单，每位顾客的概率独立计算。通过此种方式增加的额外续单将无视预算上限。',
				},
			],
			negative: [
				{
					name: '「饭要一口一口吃才健康」',
					description:
						'包括排队顾客在内的所有顾客，用餐时间增加到200%，但此技能效果优先级低于立刻完食类Buff。',
				},
			],
		},
		positiveTagMapping: {},
			...
			negative: [
				{
					name: '「现与隐的境界」',
					description:
						'在场上开启数个会变换位置的隙间，若接近隙间则会被吸入其中，然后随机传送到其他隙间处，同时托盘内的酒水会消失，持续30秒。',
				},
			],
		},
		positiveTagMapping: {
