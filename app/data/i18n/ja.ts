/**
 * 日本語ゲームデータ翻訳テーブル。
 * すべてのエンティティとスタンドアロンルックアップテーブルの翻訳を統合。キーは簡体字中国語の原文。
 * 翻訳者：空文字列を日本語翻訳に置き換えてください。
 */
