...
} from '@/features/customerPlans/constants';
import type {
	ICustomerRarePlan,
	ICustomerRarePlansState,
} from '@/features/customerPlans/contracts';

const CUSTOMER_RARE_VIRTUAL_PLAN_ID = '__virtual_default__';

function createCustomerRareVirtualPlan(): ICustomerRarePlan {
	return {
		createdAt: 0,
...
function getActiveCustomerRarePlanFromState({
	activeId,
	items,
}: ICustomerRarePlansState) {
