 ...
 */
export const RECOMMENDATION_CACHE_RECORD_VERSION = 3;
...
export const RECOMMENDATION_CACHE_DATABASE_VERSION = 2;
...
export const SPECIAL_GUEST_PLAN_CACHE_MAX_ENTRIES = 200;
export const SPECIAL_GUEST_PLAN_CACHE_MAX_MEALS = 200_000;
