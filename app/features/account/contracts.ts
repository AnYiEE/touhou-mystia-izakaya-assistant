...
import { type ACCOUNT_COOKIE_NAME_MAP } from './constants';
import type { IAccountSyncMeta } from './sync/contracts';
...
export type TAdminSsoGrantEvent = TSsoGrantEvent;
...
export type TAdminSsoCallbackDeliveryStatus = TSsoCallbackDeliveryStatus;
