...
import type { IRemoteStateApplicationGuard } from '@/infrastructure/browser/crossTab/contracts';
...
export const accountRemoteStateApplicationGuard = {
	checkApplyingRemoteState,
} satisfies IRemoteStateApplicationGuard;
