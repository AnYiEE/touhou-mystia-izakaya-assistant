...
import {type FC, type MouseEvent, type PropsWithChildren, memo, useCallback, useMemo} from 'react';
...
interface IItemPopoverCardProps extends Pick<ISpriteProps, 'target'>, RefProps<HTMLDivElement> {
	// Basic info.
	id: number;
	recipeId?: number;
	name: TItemName;
...
const ItemPopoverCardComponent = memo<PropsWithChildren<IItemPopoverCardProps>>(function ItemPopoverCard({
	children,
	cooker,
	description,
	displayName,
	...
	return (
		<div className="max-w-80 space-y-2 p-2 text-tiny text-default-800" {...props}>
