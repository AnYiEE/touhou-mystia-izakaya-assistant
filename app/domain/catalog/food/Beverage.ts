...
import type { TBeverage, TProcessedBeverage } from './types';
...
export class Beverage extends Food<TProcessedBeverage[]> {
	...
	public get sortedTags() {
		...
		if (!isTagsEqual) {
			throw new Error(
				'[domain/catalog/food/Beverage]: the given tags is inconsistent with the tags in the original data'
			);
		}
