...
export const CLOTHES_LIST = [
	...
	},
	{
		...
		name: '锦绣中华娃娃',
		description:
			'在2022年春节活动期间登陆游戏获得的限定礼服，红黄配色象征着喜气与财富，在春回大地、万象更新的这一天尽情收获祝福吧。更换该服装时，店铺的夜间装潢也会变成春节风格。',
		dlc: 0,
		gif: false,
		izakaya: true,
		from: [createKourindouPurchase(25)],
	...
	},
	{
		...
		name: '圣诞节特典晚装',
		description:
			'在2021年圣诞节活动期间登陆游戏获得的限定礼服，毛茸茸的非常暖和，在注重保暖的同时也没有舍弃可爱。在冬日里看到这样一抹亮色，会让人心情变得很好吧？更换该服装时，店铺的夜间装潢也会变成圣诞节风格。',
		dlc: 0,
		gif: false,
		izakaya: true,
		from: [createKourindouPurchase(25)],
