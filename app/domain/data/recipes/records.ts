...
import type { IRecipe } from './schema';
...
export const RECIPE_LIST = [
	...
	},
	{
		...
		name: '山泉双色果盘',
		description:
			'选取山间的泉水浸泡山上的野果而成的果盘，口感顺滑，冰凉甜美。由妖精制作的果盘更是可以保存数天而不变色，也许是她们的生命力在起效。',
		recipes: [
			{
				id: 11000,
				ingredients: ['桃子', '葡萄'],
	...
	},
	{
		...
		name: '三色花见团子',
		description:
			'红美铃拜托老板娘指导自己制作的团子料理，其实就是常见的花见团子。团子中还加入了产自美铃家乡、具有安神功效的花茶。三色团子分别是象征美铃红色长发的红豆沙团子、象征咲夜小姐银蓝色头发的奶酪团子，以及象征美铃五角星帽子的抹茶团子。此外，她还用银质飞刀和五角星作了装饰。“我们家的女仆长吃完后，竟然难得地没有去打扰还在睡觉的门番呢。”——某位不愿透露姓名的吸血鬼”我们的女仆长吃完后，难得没有打扰还在睡觉的门番呢。“——某不愿透露姓名的吸血鬼',
		recipes: [
			{
				id: 12001,
				ingredients: ['糯米', '鲜花'],
