...
import type { IOrnament } from './schema';
...
export const ORNAMENT_LIST = [
	{
		...
		from: { bond: '橙', level: 5, description: null },
	},
	{
		id: 33,
		name: '富贵牡丹',
		...
		from: { bond: '茨木华扇', level: 5, description: null },
	},
	{
		id: 34,
		name: '强运桃子',
		...
		from: { bond: '比那名居天子', level: 5, description: null },
	},
	{
		id: 50,
		name: '胖滚君',
		...
		from: { bond: '红美铃', level: 5, description: null },
	},
	{
		id: 51,
		name: '幸运的素兔？',
		...
		from: { bond: '因幡帝', level: 5, description: null },
	},
	{
		id: 62,
		name: '喜之面',
	...
	},
	{
		...
		from: { bond: '矢田寺成美', level: 5, description: null },
	},
	{
		id: 1004,
		name: '河童重工电话机',
		...
		from: { bond: '河城荷取', level: 5, description: null },
	},
	{
		id: 2003,
		name: '觉之眼',
		...
		from: { bond: '古明地觉', level: 5, description: null },
	},
	{
		id: 2004,
		name: '仇返人形',
		...
		from: { bond: '水桥帕露西', level: 5, description: null },
	},
	{
		id: 3000,
		name: '飞碟老虎机',
		...
		from: { bond: '封兽鵺', level: 5, description: null },
	},
	{
		id: 4000,
		name: '普通的钓鱼竿',
		...
		from: { bond: '今泉影狼', level: 1, description: null },
	},
	{
		id: 4001,
		name: '超级钓鱼竿',
	...
	},
	{
		...
		from: { bond: '绵月丰姬', level: 5, description: null },
	},
	{
		id: 5013,
		name: '杜门谢客',
		...
		from: { bond: '魅魔', level: 5, description: null },
	},
	{
		id: 5014,
		name: '造物者之盒',
