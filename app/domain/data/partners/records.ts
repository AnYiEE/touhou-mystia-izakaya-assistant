...
export const PARTNER_LIST = [
	...
	},
	{
		...
		name: '小野冢小町',
		description:
			'担任三途之河的摆渡人一职的死神，似乎专门负责引渡幻想乡中人类的灵魂。因为工作态度总是不紧不慢的样子，被阎魔派来旧地狱历练，最后辗转来到了夜雀食堂。虽然懒惰成性，不过性格非常爽朗，也爱聊天，是个很好相处的伙伴。如果工作能再认真一点就好了。',
		dlc: 2,
		specialGuests: [2003, 2004, 2005],
	...
	},
	{
		...
		name: '宫古芳香',
		description:
			'死后被邪仙操纵着的僵尸，因为被施加了防腐的咒语所以不会腐烂。性格不明，大概已经没有自我了吧？经常念叨一些谁也听不懂的话，不过干活的力气很大！就是吃得有点多…',
		dlc: 3,
		specialGuests: [3003, 3004, 3005],
	...
	},
	{
		...
		name: '赤蛮奇',
		description:
			'能让头飞出去的古典妖怪辘轳首！在村落里混在人类当中生活，性格方面自尊心有点高，与人类和妖怪都没法打成一片，差点就去当不良少女了…结果却来了夜雀食堂，真是个果决的性格呢。',
		dlc: 4,
		specialGuests: [4003, 4004, 4005],
