...
export const BEVERAGE_LIST = [
	...
	},
	{
		...
		name: '果味SOUR',
		description:
			'居酒屋常见的，使用烧酒和果汁，苏打勾兑的简单调酒，比起HighBall更加有日式风格。',
	...
	},
	{
		...
		name: '梅酒',
		description:
			'人间之里的人类自酿的梅子酒，因为喝起来很甜，所以经常有不了解的生物被它的后劲儿击倒。',
		tags: [1, 3, 4, 9, 12],
		dlc: 0,
		level: 2,
		price: 32,
	...
	},
	{
		...
		name: '红魔馆红茶',
		description:
			'使用柠檬，佛手柑，和女仆长精心挑选的红茶品种烘培出带有独特香味的红茶饮料，为了扩张红魔馆的威严，非常普通地以红魔馆命名。',
		tags: [-1, 4, 12, 19],
		dlc: 0,
		level: 2,
		price: 25,
	...
	},
	{
		...
		name: '姜汁汽水',
		description:
			'露易兹去人间界旅游时，从西方国家带回的气泡饮料，经过魔界各位的品尝之后获得了一致好评。使用苏打水、薄荷以及生姜萃取物混合而成，和普通的苏打水相比，增添了一份生姜的辛辣。舞对此进行改良，使用魔法制作的特殊冰块为饮品增添了一份层次感。值得一提的是，虽然名称叫做“Ginger Ale”，但是却不含酒精。',
