...
export const FOOD_LIST = [
	...
	},
	{
		...
		name: '八云豆包饭',
		description:
			'从外界引入的方便料理。将炸好的油豆腐掏空，填入米和菜混合制成的馅料，上锅蒸熟。油豆腐沁出的油被内馅充分吸收，软糯好吃不脏手，方便携带。据说蓝小姐总是带着这道菜去看望别人。什么？才不是因为我没米下锅呢，只是紫非要硬塞过来——某不知名红白巫女',
		recipes: [
			{
				id: 11027,
				ingredients: [5, 17, 28],
		...
		positiveTags: [-2, -1, 2, 3, 9, 12],
		negativeTags: [8, 18],
		dlc: 9,
		level: 2,
		price: 46,
		from: { bond: { level: 2, specialGuest: 10002 } },
	},
	{
		id: 11028,
		name: '八云海鲜煲',
		description:
			'蓝小姐针对天气热，猫猫不爱吃饭的问题研发的特效药。将新鲜的海产品加工成鱼丸等，再混入新鲜蔬菜，用鲜味十足的海胆汤煮熟。每做一碗，就需要碗口大的海胆一个，可谓十分奢侈。不过在物产丰茂的幻想乡，它也不算是什么难以负担的料理。今天尝尝小猫的口味吧~奇怪，总感觉膝盖有些酸痛——八云紫',
		recipes: [
			{
				id: 11028,
				ingredients: [1005, 23, 1002, 28],
				cookerType: 1,
				baseCookTime: 11,
			},
		],
		...
		level: 4,
		price: 157,
		from: { bond: { level: 3, specialGuest: 10002 } },
	},
	{
		id: 11029,
		name: '血池',
		description:
			'富有“真正的血池地狱风格”的一道菜，至少其制作者本人是这么宣传的。制作技巧在于不吝成本，玩命加料，无视成本。将新鲜的肉片成薄片，在浓盐重辣的红汤中烫至断生，胡乱堆在盆里，最后浇进炽热鲜辣的辣椒酱至完全看不见肉。备受热爱挑战极限的鬼们的追捧。除此之外，在老板娘的不懈研究下，为不吃辣人群特调了番茄口味。地狱每天都吃这个吗？那看来地狱还挺适合居住的嘛。——某竹林居民',
		recipes: [
			{
				id: 11029,
				ingredients: [15, 16, 20, 3, 35],
				cookerType: 1,
				baseCookTime: 19,
			},
		],
		positiveTags: [-3, -1, 0, 5, 9, 16, 18, 22, 23, 27, 34, 35],
		negativeTags: [],
		dlc: 9,
		level: 4,
		price: 194,
		from: { bond: { level: 4, specialGuest: 10002 } },
	},
	{
		id: 12000,
		name: '椰子麻薯',
