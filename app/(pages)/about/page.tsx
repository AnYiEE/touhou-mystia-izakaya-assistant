		...
		<div>
			...
			<div className="space-y-2 break-all text-justify indent-8">
				<p>
					...
					”）是为游戏《东方夜雀食堂》所打造的辅助工具，提供顾客图鉴（包括羁绊奖励和符卡效果查询）、搭配稀客和普客的料理套餐，以及料理（食谱）、酒水、食材、厨具、摆件、衣服和伙伴查询等功能，旨在为玩家的游玩过程提供帮助。
				</p>
				<p>
				...
				<p>
					...
					所提供的信息可能和现时游戏中的信息存在差异，敬请知悉，并以游戏中的信息为准。
				</p>
				<p>
					...
					。但请您注意，这仅是捐赠，无论捐赠与否都不会影响您使用{shortName}的体验。
				</p>
				<p>
					{shortName}
					始终在不断更改和改进，可能随时增加或删除功能，也可能暂停或彻底停止服务。{shortName}
					不为具体功能、可靠性、可用性或满足您需要的能力作任何承诺。某些司法管辖区域会规定特定保证，例如适销性、特定目的适用性或不侵权的默示保证。在法律允许的范围内，
					{shortName}排除所有保证。
				</p>
			</div>
			<ChangeLog />
