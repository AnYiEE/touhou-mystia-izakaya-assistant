	...
	return (
		<>
			...
			<div className="space-y-2 break-all text-justify indent-8">
				<p>
					以下法律声明适用于中华人民共和国（不含香港特别行政区、澳门特别行政区、台湾地区）以及{shortName}
				...
				<p>
					作为开发者，我向您授予一项可撤销、不可转让、非独占的许可，允许您合法使用{shortName}
					。除非另有书面许可，本声明未明示授权的权利均由我保留。未行使权利并不构成对该权利的放弃或默示许可。同时，我保留在开发和运营
					{shortName}
					的过程中，所产生的所有数字资产、内容和相关知识产权的所有权，未经书面许可，您不得擅自使用。
				</p>
				<p>
					作为开发者，我无法保证{shortName}的内容在所有司法管辖区均合法。您在访问、使用、复制或传播{shortName}
