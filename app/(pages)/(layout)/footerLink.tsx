...
import {type ILinkProps, type ITooltipProps, Link, Tooltip, cn} from '@/design/ui/components';

interface IFooterLinkProps extends Pick<ILinkProps, 'href' | 'isExternal' | 'title'> {
	content?: ReactNodeWithoutBoolean;
}

export const FooterLink = memo<PropsWithChildren<IFooterLinkProps>>(function FooterLink({
	children,
	content,
	href = '#',
	isExternal = true,
...
interface IFooterLinkWithTooltipProps extends IFooterLinkProps, Pick<ITooltipProps, 'classNames'> {
	content: ReactNodeWithoutBoolean;
}

export const FooterLinkWithTooltip = memo<PropsWithChildren<IFooterLinkWithTooltipProps>>(
