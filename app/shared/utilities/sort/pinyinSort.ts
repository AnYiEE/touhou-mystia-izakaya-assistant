import { isValueCollection } from '@/shared/utilities/objects/convertCollection';
import { getPinyin } from '@/shared/utilities/pinyin/getPinyin';
import { getTone, removeTone } from '@/shared/utilities/pinyin/processPinyin';
...
function throwError(...args: unknown[]): never {
	throw new TypeError(
		`[shared/utilities/sort/pinyinSort]: invalid parameter: ${args.join('; ')}`
	);
}
